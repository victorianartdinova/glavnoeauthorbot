...
def generate_carousel_brief(input_data: LeadgenCardsInput) -> str:
    """
    Генерация ТЗ для карусели (5-8 карточек)

    Структура: hook → проблема → решение → кейс/цифра → оффер → CTA
    """
    cards = []
    cards.append("""
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🎨 ТЗ ДИЗАЙНЕРУ: КАРУСЕЛЬ (5-8 КАРТОЧЕК)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

КАРТОЧКА 1: ХУК
• Текст: ❓ Вопрос-крючок или 💰 Ценовой триггер
• Визуал: Минимализм, акцент на цифре
• Цель: Зацепить внимание, заставить листать

КАРТОЧКА 2: ПРОБЛЕМА
• Текст: Боль или ситуация аудитории
• Визуал: Иконка проблемы или emoji
• Цель: Создать эмпатию

КАРТОЧКА 3: РЕШЕНИЕ
• Текст: Как объект решает проблему
• Визуал: Преимущество (локация/планировка/класс)
• Цель: Показать выгоду

КАРТОЧКА 4: КЕЙС/ЦИФРЫ
• Текст: Реальный пример или статистика
• Визуал: Цифры, график, фото довольного клиента
• Цель: Доказать ценность

КАРТОЧКА 5: ОФФЕР
• Текст: Конкретное предложение (цена, условия, акция)
• Визуал: Таблица условий или highlight цены
• Цель: Дать финансовую ясность

КАРТОЧКА 6: CTA
• Текст: Призыв к действию
• Визуал: Кнопка или стрелка
• Цель: Подтолкнуть к контакту

[+ дополнительные карточки 7-8 если нужно — фишки ЖК, инфраструктура]

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ОБЩИЕ ТРЕБОВАНИЯ:
• Формат: вертикальный 1080x1920 (story)
• Переходы: swipe влево
• Навигация: точки внизу (1/6, 2/6...)
• Цвета: фирменная палитра клиента
• Шрифты: крупные, читаемые с телефона
• Нельзя: указывать название ЖК напрямую
""")
