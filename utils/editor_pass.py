...
ЗАДАЧА: Сделать текст МЯГЧЕ, но СОХРАНИ суть и содержание.

ПРАВИЛА:
1. Смягчи ТОЛЬКО тон (убери излишнюю жёсткость)
2. Добавь 1-2 эмоциональных штриха (максимум)
3. Расширь максимум на 10% слов
4. СОХРАНИ все факты, цифры, структуру
5. СОХРАНИ все эмодзи и блоки
6. CTA остаётся БЕЗ изменений

ВАЖНО: Не переделывай текст! Только смягчи тон.

Верни ТОЛЬКО отредактированный текст, без комментариев."""

        user_prompt = f"""Смягчи ТОЛЬКО тон этого поста (не меняй содержание):
